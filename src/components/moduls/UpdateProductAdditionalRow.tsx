...
import {useDeleteMutation, useUpdateMutation as useUpdateAdditionMutation} from "@/services/apiProductAdditional.ts";
import {
    AlertDialog,
    AlertDialogAction,
    AlertDialogCancel,
...
const UpdateProductAdditionalRow = ({
    ...
    const [deleteAddtion, {isLoading: isDeleting}] = useDeleteMutation();
                            ...
                            <TableCell>
                                <div className="flex items-center gap-2 relative">
                                    ...
                                    <Button
                                        ...
                                        variant="ghost"
                                        size="icon-sm"
                                        className="shrink-0 text-destructive hover:bg-destructive/10 hover:text-destructive absolute right-0"
                                        disabled={isDeleting}
                                        onClick={(e) => {
                                            e.stopPropagation();
                                            setDeleteOpen(true);
                                        ...
                                        title={`Видалити "${additional.name}"`}
                                    >
            ...
            <AlertDialog open={deleteOpen} onOpenChange={setDeleteOpen}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogTitle>
                            Видалити "{additional.name}"?
                        </AlertDialogTitle>

                        <AlertDialogDescription>
                            Цю дію неможливо скасувати. Група буде видалена
                            разом із усіма її додатками.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
